...
def solve(initial_state, max_memory=5000):
    """LMA* com limite de memória melhorado (H3 - Combinada)."""
    start_time = time.time()
    root = Node(initial_state, None, None, 0, heuristic_h3(initial_state))
    ...
    while open_list:
        ...
        if best_node.state.is_goal():
            ...
            while curr.parent:
                ...
                curr = curr.parent
            return {
                "name": f"LMA* com Heurística Combinada (H3) - Memória: {max_memory}",
